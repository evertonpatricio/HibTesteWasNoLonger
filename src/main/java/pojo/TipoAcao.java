...
public class TipoAcao implements Serializable{
	...
	@Id
	@Column(name = "id")
	@GeneratedValue(generator = "tipo_acao_id_seq", strategy = GenerationType.SEQUENCE)
	@SequenceGenerator(name = "tipo_acao_id_seq", sequenceName = "tipo_acao_id_seq", allocationSize = 1)
	public Long getId() {
		return id;
	}
